...
# the reason we setup the default key in the STRIPE_PUB_KEY or STRIP_SECRET_KEY is for if we coudnt find the value from settings
# but we can run an error message if we could not find the default value
    ...
    if product_id is not None:
        ...
        if request.is_ajax(): # Asynchronous JavaScript And XML / JSON
            ...
            json_data={
                ...
                # the variable in json should not contains _ or - it should be cartItem instead of cart-item (recommended)
            }
