...
class ReactivateEmailForm(forms.Form):
    ...
    # Clean_email is built in method , i tried to make it cleaned_email and didn't work
...
class LoginForm(forms.Form):
        ...
        if qs.exists():
            ...
            if not_active.exists():
                ...
                if not is_confirmable and not email_confirm_exists:
                    raise forms.ValidationError("This Email is inactive")
    ...
    #             messages.error(request, "this is inactive")
...
class RegisterForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        user.set_password(self.cleaned_data["password1"])
        user.is_active= False # user must confirm his email first
        # sending an activation email via signals
